...
import com.reto2.jwt.JwtTokenFilter;
...
//                        .antMatchers("/products/**").hasAuthority(ERole.USER.name())
                                .antMatchers("/account/**").hasAuthority(ERole.DIRECTOR.name())
                                .antMatchers(HttpMethod.GET, "/account/**").hasAnyAuthority(ERole.CAJERO.name())
